export const cards = [
            ...
            { id: 103, level: 3, category: 'couple', question: '你觉得「成功」是什么？我们对成功的定义会冲突吗？' },
            { id: 104, level: 3, category: 'couple', question: '最想成为怎样的一个人？现在的我在帮你成为那个人吗？' },
            { id: 105, level: 3, category: 'couple', question: '信仰在我们关系里应该扮演什么角色？我们如何一起实践？' },
            { id: 106, level: 3, category: 'couple', question: '你后悔过人生里的哪个决定？它如何影响你对未来的选择？' },
            { id: 107, level: 3, category: 'couple', question: '如果我们对某件事的看法永远不一致，你会怎么接受？' },
            { id: 108, level: 3, category: 'couple', question: '你觉得两个人在一起，什么条件是可以妥协的，什么绝对不能？' },
            // 主题二：金钱观与生活习惯
            { id: 109, level: 3, category: 'couple', question: '你对花钱和存钱的底线是什么？我们会不会为钱吵架？' },
            { id: 110, level: 3, category: 'couple', question: '如果突然有了一笔钱，你第一件事想做什么？' },
            { id: 111, level: 3, category: 'couple', question: '你觉得我们之间「公平」意味着什么？举一个具体例子。' },
            { id: 112, level: 3, category: 'couple', question: '你希望我们两个人是各自独立、还是事无巨细分享？' },
            { id: 113, level: 3, category: 'couple', question: '当你压力大的时候，你希望我靠近你，还是给我空间？' },
            { id: 114, level: 3, category: 'couple', question: '我们的家，你希望布置成什么样？用什么词形容？' },
            // 主题三：原生家庭与亲密关系
            { id: 115, level: 3, category: 'couple', question: '你家里你最想传承给下一代的好习惯是什么？' },
            { id: 116, level: 3, category: 'couple', question: '你父母的关系里，哪一点是你希望我们一定不要重蹈的？' },
            { id: 117, level: 3, category: 'couple', question: '你觉得「家」对你的意义是什么？它该是什么感觉？' },
            { id: 118, level: 3, category: 'couple', question: '我们各自和家人之间，你希望我扮演怎样的角色？' },
            { id: 119, level: 3, category: 'couple', question: '有哪些话你是从父母那里听到、现在觉得需要重新思考的？' },
            { id: 120, level: 3, category: 'couple', question: '如果我们将来有孩子，你希望我「像现在这样」还是「变一个样」？' },
            // 主题四：冲突、脆弱与承诺
            { id: 121, level: 3, category: 'couple', question: '我们吵架的时候，你最希望我做的第一件事是什么？' },
            { id: 122, level: 3, category: 'couple', question: '有没有哪次我们吵架，你其实是想表达「我需要被在乎」？' },
            { id: 123, level: 3, category: 'couple', question: '你最想让我了解你内心的哪一部分？我一直没看见的部分。' },
            { id: 124, level: 3, category: 'couple', question: '你觉得我们关系里最坚固的一块基石是什么？' },
            { id: 125, level: 3, category: 'couple', question: '如果有一天我们不再爱了，你希望我们怎么处理？' },
            { id: 126, level: 3, category: 'couple', question: '你会在什么时候觉得「这段关系值得」？最近一次是什么时候？' },
